...
function SignUp() {
  const [signUpStatus,changeStatus]=useState('false');
  ...
  return (
    <>
    { message && (
        <div className={`alert ${signUpStatus ? 'alert-success' : 'alert-danger'}`} role="alert">
        {message}
      </div>
      )
    }
  ...
  <div className="mb-3 mt-4 ms-4">
    ...
    <input type="text" className="form-control" id="name" value={userData.name} onChange={handleChange} name='name'/>
    </div>
  <div className="mb-3 mt-4 ms-4">
